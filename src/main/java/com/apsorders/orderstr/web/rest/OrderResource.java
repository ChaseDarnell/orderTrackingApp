...
/**
 * REST controller for managing {@link com.apsorders.orderstr.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Order> partialUpdateOrder(
        ...
        Optional<Order> result = orderRepository
            ...
            .map(existingOrder -> {
                ...
                if (order.getNoteso() != null) {
                    existingOrder.setNoteso(order.getNoteso());
                }
                if (order.getScan() != null) {
                    existingOrder.setScan(order.getScan());
                }
                if (order.getScanContentType() != null) {
                    existingOrder.setScanContentType(order.getScanContentType());
                }
