...
import com.apsorders.orderstr.domain.Customer;
import com.apsorders.orderstr.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_NOTESC = "AAAAAAAAAA";
    private static final String UPDATED_NOTESC = "BBBBBBBBBB";
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).locale(DEFAULT_LOCALE).notesc(DEFAULT_NOTESC);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).locale(UPDATED_LOCALE).notesc(UPDATED_NOTESC);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getNotesc()).isEqualTo(DEFAULT_NOTESC);
    }
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].notesc").value(hasItem(DEFAULT_NOTESC)));
    }
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.notesc").value(DEFAULT_NOTESC));
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).locale(UPDATED_LOCALE).notesc(UPDATED_NOTESC);
        ...
        assertThat(testCustomer.getNotesc()).isEqualTo(UPDATED_NOTESC);
    }
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).locale(UPDATED_LOCALE).notesc(UPDATED_NOTESC);
